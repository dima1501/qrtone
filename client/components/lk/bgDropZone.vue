<template lang="pug">
    .dropzone-wrapper
                    ...
                    .st-dropzone__inner
                        .st-dropzone__content
                            transition(name="slide-fade" mode="out-in")
                                .st-dropzone__image(v-if="$store.state.view.loading.uploadBg" key='logo_dropzone_image_logo')
                                ...
                                .st-dropzone__image(
                                    ...
                                    v-bind:style="{ backgroundImage: 'url(../../uploads/' + ($store.state.auth.user.bgWebp ? '560-' : '') + $store.state.auth.user.background + ')' }")
                                .st-dropzone__image(
                            ...
                            h4.st-dropzone__title Фоновое изображение
                            transition(name="slide-fade" mode="out-in")
        ...
        transition(name="slide-fade")
            ...
            .st-dropzone__links(v-if="$store.state.auth.user.background && !uploadImage.src" key='logo_dropzone_logo_delete')
